...
if (!isAdmin() || !isLoggedIn()) {
    ...
    echo '<div class="text-center py-8"><i class="fas fa-exclamation-circle text-red-500 text-2xl mb-4"></i><p class="text-red-500">Unauthorized access</p></div>';
    exit();
}
...
<?php
    ...
    error_log("Error in get_election_candidates.php: " . $e->getMessage());
    echo '<div class="text-center py-8"><i class="fas fa-exclamation-circle text-red-500 text-2xl mb-4"></i><p class="text-red-500">Error loading candidates: ' . htmlspecialchars($e->getMessage()) . '</p></div>';
}
?>